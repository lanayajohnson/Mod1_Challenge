...
print(f"There are {total_number_of_loans} total number of loans.")

# There are 5 total number of loans
...
print(f"There is a ${total_loan_value} total loan value.")

# There is a $2750 total loan value
...
average_loan_price = sum(loan_costs) / total_number_of_loans
print(f"The average loan price is ${average_loan_price: .2f}")


# The average loan price is $550.00
...
# The remaining months are 9 months
...
print(f" The Present Value for loans is , ${Present_Value: .2f}")

# The Present Value for loans is $861.77
...
print(f" The Present value for new loan is , ${Present_Value: .2f}")


# The Present Value for the new loan is $820.08
...
with open (csvpath, 'w', newline= '') as csvfile:
    ...
    for item in loans:
        if item.get("loan_price") in inexpensive_loans:
